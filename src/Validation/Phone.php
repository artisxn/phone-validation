<?php namespace codicastudio\LaravelPhone\Validation;

use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use libphonenumber\PhoneNumberUtil;
use codicastudio\LaravelPhone\Exceptions\InvalidParameterException;
use libphonenumber\NumberParseException;
use codicastudio\LaravelPhone\PhoneNumber;
...
class Phone
{
     ...
     * @param array  $data
     * @return array
     * @throws \codicastudio\LaravelPhone\Exceptions\InvalidParameterException
     */
