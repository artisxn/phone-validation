...
use codicastudio\LaravelPhone\Exceptions\NumberFormatException;
use codicastudio\LaravelPhone\Exceptions\CountryCodeException;
use codicastudio\LaravelPhone\Exceptions\NumberParseException;
use codicastudio\LaravelPhone\Traits\ParsesCountries;
use codicastudio\LaravelPhone\Traits\ParsesFormats;
use codicastudio\LaravelPhone\Traits\ParsesTypes;
use Serializable;
...
class PhoneNumber implements Jsonable, JsonSerializable, Serializable
{
     ...
     * @param string $format
     * @return string
     * @throws \codicastudio\LaravelPhone\Exceptions\NumberFormatException
     */
     ...
     * @return string
     * @throws \codicastudio\LaravelPhone\Exceptions\CountryCodeException
     */
     ...
     * @return string
     * @throws \codicastudio\LaravelPhone\Exceptions\NumberParseException
     */
